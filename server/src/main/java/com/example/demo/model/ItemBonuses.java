...
public class ItemBonuses {
    ...
    /**
     * @return the armor_percent
     */
    public Integer getArmor_percent() {
        return armor_percent;
    }

    /**
     * @param armor_percent the armor_percent to set
     */
    public void setArmor_percent(Integer armor_percent) {
    ...
    /**
     * @return the damage_bleed
     */
    public Integer getDamage_bleed() {
        return damage_bleed;
    }

    /**
     * @param damage_bleed the damage_bleed to set
     */
    public void setDamage_bleed(Integer damage_bleed) {
        this.damage_bleed = damage_bleed;
    }

    /**
     * @return the damage_cold
     */
    public Integer getDamage_cold() {
        return damage_cold;
    }

    /**
     * @param damage_cold the damage_cold to set
     */
    public void setDamage_cold(Integer damage_cold) {
        this.damage_cold = damage_cold;
    }

    /**
     * @return the damage_electric
     */
    public Integer getDamage_electric() {
        return damage_electric;
    }

    /**
     * @param damage_electric the damage_electric to set
     */
    public void setDamage_electric(Integer damage_electric) {
        this.damage_electric = damage_electric;
    }

    /**
     * @return the damage_fire
     */
    public Integer getDamage_fire() {
        return damage_fire;
    }

    /**
     * @param damage_fire the damage_fire to set
     */
    public void setDamage_fire(Integer damage_fire) {
        this.damage_fire = damage_fire;
    }

    /**
     * @return the damage_poison
     */
    public Integer getDamage_poison() {
        return damage_poison;
    }

    /**
     * @param damage_poison the damage_poison to set
     */
    public void setDamage_poison(Integer damage_poison) {
        this.damage_poison = damage_poison;
    }
    ...
    /**
     * @return the health_percent
     */
    public Integer getHealth_percent() {
        return health_percent;
    }

    /**
     * @param health_percent the health_percent to set
     */
    public void setHealth_percent(Integer health_percent) {
    ...
    private Integer agility_percent = 0;
    private Integer agility = 0;
    private Integer armor = 0;
    private Integer armor_percent = 0;
    private Integer attack_speed = 0;
    private Integer block_chance = 0;
    private Integer block = 0;
    private Integer def_ability = 0;
    private Integer def_ability_percent = 0;
    private Integer damage = 0;
    private Integer damage_bleed = 0;
    private Integer damage_cold = 0;
    private Integer damage_electric = 0;
    ...
    private Integer fire_percent = 0;
    private Integer poison_percent = 0;
    private Integer health = 0;
    private Integer health_percent = 0;
    private Integer health_regen = 0;
    private Integer intelligence = 0;
    private Integer intelligence_percent = 0;
    private Integer max_bleed = 0;
    private Integer min_bleed = 0;
    private Integer max_cold = 0;
    private Integer min_cold = 0;
    private Integer max_damage = 0;
    private Integer min_damage = 0;
    private Integer max_electric = 0;
    private Integer min_electric = 0;
    private Integer max_poison = 0;
    private Integer min_poison = 0;
    private Integer max_fire = 0;
    ...
    private Integer res_fire = 0;
    private Integer res_stun = 0;
    private Integer res_poison = 0;
    private Integer slow = 0;
    private Integer strength = 0;
    private Integer strength_percent = 0;
    private Integer stun_chance = 0;
    ...
    public Hero addBonuses(Hero input) {
        Hero hero = input;
        hero.setAgility(hero.getAgility() + this.agility);
        hero.setAgility_percent(hero.getAgility_percent() + this.agility_percent);
        hero.setAttack_speed(hero.getAttack_speed() + this.attack_speed);
        hero.setBleed_percent(hero.getBleed_percent() + this.bleed_percent);
        hero.setBlock(hero.getBlock() + this.block);
        hero.setBlock_chance(hero.getBlock_chance() + this.block_chance);
        hero.setCold_percent(hero.getCold_percent() + this.cold_percent);
        hero.setDef_ability(hero.getDef_ability() + this.def_ability);
        ...
        hero.setMax_electric(hero.getMax_electric() + this.max_electric + this.damage_electric);
        hero.setMax_fire(hero.getMax_fire() + this.max_fire + this.damage_fire);
        hero.setMax_poison(hero.getMax_poison() + this.max_poison + this.damage_poison);
        hero.setMin_bleed(hero.getMin_bleed() + this.min_bleed + this.damage_bleed);
        hero.setMin_cold(hero.getMin_cold() + this.min_cold + this.damage_cold);
        hero.setMin_electric(hero.getMin_electric() + this.min_electric + this.damage_electric);
        hero.setMin_damage(hero.getMin_damage() + this.min_damage + this.damage);
        hero.setMin_fire(hero.getMin_fire() + this.min_fire + this.damage_fire);
        hero.setMin_poison(hero.getMin_poison() + this.min_poison + this.damage_poison);
        hero.setOff_ability(hero.getOff_ability() + this.off_ability);
        hero.setOff_ability_percent(hero.getOff_ability_percent() + this.off_ability_percent);
        hero.setPoison_percent(hero.getPoison_percent() + this.poison_percent);
        hero.setRes_bleed(hero.getRes_bleed() + this.res_bleed);
        hero.setRes_cold(hero.getRes_cold() + this.res_cold);
        hero.setRes_electric(hero.getRes_electric() + this.res_electric);
        hero.setRes_fire(hero.getRes_fire() + this.res_fire);
        hero.setRes_poison(hero.getRes_poison() + this.res_poison);
        hero.setRes_stun(hero.getRes_stun() + this.res_stun);
        hero.setSlow(hero.getSlow() + this.slow);
        hero.setStrength(hero.getStrength() + this.strength);
        hero.setStrength_percent(hero.getStrength_percent() + this.strength_percent);
        hero.setStun_chance(hero.getStun_chance() + this.strength_percent);

        hero.setOff_ability(hero.getOff_ability() + this.agility);
        hero.setDef_ability(hero.getDef_ability() + this.agility);
        hero.setMin_damage(hero.getMin_damage() + this.strength);
        hero.setMax_damage(hero.getMax_damage() + this.strength);

        return hero;
    }

    public Hero deductBonuses(Hero input) {
        Hero hero = input;
        hero.setAgility(hero.getAgility() - this.agility);
        hero.setAgility_percent(hero.getAgility_percent() - this.agility_percent);
        hero.setAttack_speed(hero.getAttack_speed() - this.attack_speed);
